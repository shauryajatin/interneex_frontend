    ...
    <div className="relative w-full">
      <div className="grid grid-cols-1 lg:grid-cols-4 sm:mt-2 mt-6 mb-6">
        <div className="col-span-4 sm:pl-6 lg:col-span-1 lg:pl-10 lg:pr-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Meet Our Mentors</h2>
          <p className="mb-6 lg:py-8 text-sm sm:text-base">
          ...
          <div className="flex self-end mt-8 sm:mt-14">
        ...
        <div className="col-span-4 lg:col-span-3">
          ...
          >
            {mentors.map((mentor, index) => (
              <div
                key={index}
                className="min-w-[200px] sm:min-w-[250px] lg:min-w-[300px] min-h-[300px] sm:min-h-[400px] lg:min-h-[500px] bg-purple-100 rounded-lg shadow-lg p-4"
              >
                {mentor.img ? (
                  <img
                    src={mentor.img}
